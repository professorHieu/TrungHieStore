...
$(".container-product-sales-slider").slick({
    ...
    autoplay: true,
    autoplaySpeed: 3000,
    prevArrow: '<button class="slick-prev slick-arrow"><i class="fa-solid fa-angle-left" aria-hidden="true"></i></button>',
    nextArrow: '<button class="slick-next slick-arrow"><i class="fa-solid fa-angle-right" aria-hidden="true"></fa-solid></button>',
    responsive: [{
            breakpoint: 1024,
            settings: {
                slidesToShow: 3,
