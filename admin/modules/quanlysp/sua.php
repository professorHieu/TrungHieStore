...
<table style="width: 100%;" class="table table-bordered">
    ...
    ?>
        <form method="POST" action="modules/quanlysp/xuly.php?idsanpham=<?php echo $row['id_sp'] ?>" enctype="multipart/form-data">
            <tr>
                <td>Tên sản phẩm</td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div style="display: none;">
                        <input hidden name="mota" id="motasanpham" value="<?php echo htmlentities($row['mota']) ?>"></input>
                    </div>
