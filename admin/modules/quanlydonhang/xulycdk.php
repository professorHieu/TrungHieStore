...
if (isset($_GET['code'])) {
  $code_cart = $_GET['code'];
  $sql_update = "UPDATE tbl_cart_unregistered SET cart_status=0  WHERE code_cart='" . $code_cart . "'";
  $query = mysqli_query($mysqli, $sql_update);

  //Thong ke doanh thu
  $sql_lietke_dh = "SELECT * FROM tbl_cart_details,tbl_sanpham WHERE tbl_cart_details.id_sp=tbl_sanpham.id_sp AND tbl_cart_details.code_cart='$code_cart' ORDER BY tbl_cart_details.id_cart_details DESC";
