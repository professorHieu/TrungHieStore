<div class="page-cart">
    <div class="page-cart-heading">
        <img src="././assets/img/new1.jpg" alt="" class="page-cart-heading-img">
    ...
    <table style="width:100%;" class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                <a style="text-decoration: none;color: #fff;padding: 2px 6px; background-color:#000;border-radius: 2px;border-radius:10px"
        ...
        <tr>
            <td colspan="8">
                ...
                <p style="float: right;">
                    <a style="color: #fff; text-decoration: none;font-size: 18px;font-weight: normal;background-color: #000;border-radius: 2px;border: none; padding: 5px 10px;border-radius:10px"
                ...
                <p style="text-align:center">
                <p style="text-align:center">
                    <a style="font-weight: normal;text-decoration: none;padding: 5px 10px; background-color:#000;color:#fff;font-size: 18px;border-radius:10px;float:left"
                ...
                <p style="text-align:center">
                    <a style="font-weight: normal;text-decoration: none;padding: 5px 10px; background-color:#000;color:#fff;font-size: 18px;border-radius:10px"
                        href="sign-up.php">
                        Đăng ký
                    </a>
                </p>
