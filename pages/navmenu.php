...
<nav class="navmenu js-navmenu">
    ...
    <a href="index.php"><img src="./assets/img/Newlogo.jpg" alt="" class="navmenu-logo" ></a>
    <div class="navmenu-list js-navmenu-list">
        ...
        <div class="navmenu-items">
            <a href="index.php?quanly=baiviet" class="navmenu-items-link">Bài viết</a>
        </div>
        <div class="navmenu-items">
    ...
    <div class="navmenu-search js-search">
        <form class="form-search" action="index.php?quanly=timkiem" method="POST">
            <input type="text" name="tukhoa" id="search" placeholder="Tên sản phẩm...">
